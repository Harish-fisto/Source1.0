class DashboardSPA {
    constructor() {
        ...
        this.designationMenus = {
            'CEO': [
                ...
                { id: 'registration', icon: 'fas fa-user-plus', text: 'Registration' },
            ...
            'Junior Developer': [
                ...
                { id: 'clients', icon: 'fas fa-handshake', text: 'Clients' },
                { id: 'projects', icon: 'fas fa-project-diagram', text: 'Projects' },
                { id: 'task', icon: 'fas fa-handshake', text: 'Task Allocation' },
                { id: 'leave', icon: 'fas fa-calendar-check', text: 'Request' },
                { id: 'dailyreport', icon: 'fas fa-clipboard-list', text: 'Daily Reports' },
    ...
    initializeDashboard() {
        ...
        // Show random quote if function exists
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        if (window.dashboardSPA.initialize()) {
            ...
            window.navigateToSection = (section) => window.dashboardSPA.navigateToSection(section);
...
// project and task allocation dynamic 
